...
interface CategoriesInterface{
    ...
    public function show(Categories $category, string $id) : JsonResponse;
}
...
class CategoriesController extends Controller
{
    ...
    public function index() : JsonResponse
    {
          $categories = Categories::with('children')->wherenull('parent_id')->find($id);
    ...
    public function destroy(Categories $category, string $id) : JsonResponse
    {
